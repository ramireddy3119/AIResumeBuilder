...
const Testimonial = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="Don't just take our words" description="Here what our users say about us. We're always looking for ways to improve. If you have a positive experience with us, leave us a review."/>
        <style>{`
